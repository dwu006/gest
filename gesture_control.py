...
# -*- coding: utf-8 -*-
"""
LeRobot Gesture Control
Real-time hand gesture recognition for VLA robot control
"""
...
def get_args():
    parser = argparse.ArgumentParser(description="LeRobot Gesture Control System")
    parser.add_argument("--width", type=int, default=640)
    parser.add_argument("--height", type=int, default=480)
    parser.add_argument("--table_distance", type=float, default=0.8,
                        help="Table distance in meters")
    parser.add_argument("--robot", type=str, default=None,
                        help="Robot configuration name (if using actual robot)")
...
def main():
    ...
    # Initialize VLA bridge (TODO: pass actual robot instance)
    vla_bridge = GestureToVLABridge(
        output_dir=args.output_dir,
        robot=None  # Pass robot instance here when ready
    )
    ...
    print("\n" + "="*70)
    print("LeRobot Gesture Control System")
    print("="*70)
    print("Gestures:")
    print("  OPEN PALM  -> STOP (emergency halt)")
    print("  POINTER    -> GOTO (navigate to location)")
    print("  FIST       -> PICK (grasp object)")
    print("\nMode: Real-time gesture -> VLA instruction")
    print("All gestures are sent immediately when detected")
