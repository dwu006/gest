...
def main():
    logging.info("Configuring Xlerobot (No Left Arm Calibration)")
    robot_config = XLerobotConfig(id="my_xlerobot_pc")
    robot = XLerobot(robot_config)

    logging.info("Connecting Xlerobot without calibration")
    # Connect without calibration to skip the broken left arm
    robot.connect(calibrate=False)
    logging.info("✓ Connected successfully (calibration skipped)")
